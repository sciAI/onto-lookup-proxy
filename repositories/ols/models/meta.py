...
class Meta(object):
    ...
    def __init__(self, ontology_xpath='embedded.ontologies', ontology=None, concept_xpath='embedded.terms', concept=None, search_xpath='response.docs', search=None, pages=None):
        """
